...
*^yes. This looks good! I am a understanding that the rule_one and rule_two part are functioning to check for normal distribution? It is helpful to use "print" to give a message for when it doesn't fall in the distrbution, but maybe that is part of the cat() function that I am unaware of*
